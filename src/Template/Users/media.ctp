...
<hr>
	<ol class="fukidashi-header-menu">
		<span class="fukidashi-header-menu-item"><a href="/users/view/<?= h($user_info["username"]) ?>">ふきだし</a></span><span class="fukidashi-header-menu-item"><a href="/users/reply/<?= h($user_info["username"]) ?>">返信</a></span><span class="fukidashi-header-menu-item">メディア</span>
	</ol>
