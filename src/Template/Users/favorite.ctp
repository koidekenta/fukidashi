...
<div id="user_info">
	...
	<div class="user_info_item" style="border-bottom: #04C1FB solid 3px;"><span>お気に入り</span><a href="/users/favorite/<?= $user_info->username ?>" class="br"><?= $user_info->favorite_num ?></a></div>
...
<hr>
	<ol class="fukidashi-header-menu">
		<span class="fukidashi-header-menu-item"><a href="/users/view/<?= h($user_info["username"]) ?>">ふきだし</a></span><span class="fukidashi-header-menu-item"><a href="/users/reply/<?= h($user_info["username"]) ?>">返信</a></span><span class="fukidashi-header-menu-item">お気に入り</span>
	</ol>
